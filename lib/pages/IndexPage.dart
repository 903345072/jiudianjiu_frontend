  ...
  Widget build(BuildContext context) {
    final List<BottomNavigationBarItem> bottomNavItems = [
      BottomNavigationBarItem(
        activeIcon: Icon(Icons.home,color: Color(0xffff2a2a)),
        backgroundColor: Colors.black,
        icon: Icon(Icons.home),
        title: Text("首页"),
      ),
      BottomNavigationBarItem(
        activeIcon: Icon(const IconData(0xe66c, fontFamily: 'iconfont'),color: Color(0xffff2a2a)),
        backgroundColor: Colors.black,
        icon: Icon(const IconData(0xe66c, fontFamily: 'iconfont')),
        title: Text("行情"),
      ),
      BottomNavigationBarItem(
        activeIcon: Icon(const IconData(0xe60d, fontFamily: 'iconfont'),color: Color(0xffff2a2a),),
        backgroundColor: Colors.black,
        icon: Icon(const IconData(0xe60d, fontFamily: 'iconfont')),
        title: Text("合约"),
      ),
      BottomNavigationBarItem(
        activeIcon: Icon(Icons.person,color:Color(0xffff2a2a),),
        backgroundColor: Colors.black,
